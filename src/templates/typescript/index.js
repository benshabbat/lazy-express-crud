...
export { getControllerTemplateTS } from './controllerTemplate.js';
export { getServiceTemplateTS } from './serviceTemplate.js';
export { getModelTemplateTS } from './modelTemplate.js';
